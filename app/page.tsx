...
import { MessageCircle, Shield, Users, Star, CheckCircle, Phone, Mail, Clock, Zap, Heart, ArrowRight, Menu, X } from 'lucide-react'
...
Aguardo o contato!`
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Heart className="h-8 w-8 text-[#6B7C32]" />
            ...
            {articles.map((article, index) => (
              <article key={index} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
                <div className="p-6">
                  ...
                  <button className="text-[#6B7C32] font-semibold hover:text-[#5A6B2A] transition-colors flex items-center">
                    Ler artigo
                ...
                <div className="border-t pt-4">
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-[#6B7C32] font-medium">{testimonial.result}</p>
                    </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-[#6B7C32]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">
            Pronto para transformar seus resultados?
          </h2>
          <p className="text-xl text-gray-100 mb-8">
            Nossa consultoria personalizada vai acelerar seus objetivos com a suplementação ideal
          </p>
          <button 
            onClick={() => document.getElementById('consultoria')?.scrollIntoView({ behavior: 'smooth' })}
            className="bg-white text-[#6B7C32] px-8 py-4 rounded-lg font-semibold hover:bg-gray-100 transition-colors inline-flex items-center text-lg"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                <Heart className="h-8 w-8 text-[#6B7C32]" />
                <span className="ml-2 text-xl font-bold">VitalSupp</span>
              </div>
              <p className="text-gray-400">
                Sua jornada para uma suplementação inteligente e resultados excepcionais.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="space-y-2 text-gray-400">
                ...
                <div className="flex items-center">
                  ...
                  contato@vitalsupp.com
                </div>
              </div>
            </div>
          </div>
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
            <p>&copy; 2024 VitalSupp. Todos os direitos reservados.</p>
          </div>
        </div>
      </footer>
    </div>
